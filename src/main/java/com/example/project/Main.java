...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(Encryptor.encryptMessage("HI GUYS I AM ZENAN", 10));
        System.out.println(Encryptor.decryptMessage("lsai h nysaewoenm a ewitno n o ftekyor=======Aak steol tt hs aecnb rte noerwo h ebad======", 45));
    }
}
